                        ...
                        <div class="w-full">
                            ...
                            <form method="POST" action="/product">
                                ...
                                <div class="sm:col-span-6">
                                    ...
                                    <div class="mt-1">
                                        <textarea style="align-content:center; overflow:auto;height: 100px;  resize: none;"   name="desc"class="block w-full appearance-none bg-white border border-gray-400 rounded-md py-2 px-3 text-base leading-normal transition duration-150 ease-in-out sm:text-sm sm:leading-5" ></textarea>
                                    </div>
                                    @error('number_phone')
                                        <div class="text-sm text-red-400">{{ $message }}</div>
                                    @enderror
